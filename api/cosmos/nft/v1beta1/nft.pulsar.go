...
var (
	...
	fd_Class_total_supply protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Class_total_supply = md_Class.Fields().ByName("total_supply")
}
...
func (x *fastReflection_Class) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TotalSupply != uint64(0) {
		...
		if !f(fd_Class_total_supply, value) {
			return
		}
	}
}
...
func (x *fastReflection_Class) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.nft.v1beta1.Class.data":
		return x.Data != nil
	case "cosmos.nft.v1beta1.Class.total_supply":
...
func (x *fastReflection_Class) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.nft.v1beta1.Class.total_supply":
		panic(fmt.Errorf("field total_supply of message cosmos.nft.v1beta1.Class is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.nft.v1beta1.Class"))
		}
...
func (x *Class) GetTotalSupply() uint64 {
	if x != nil {
...
var file_cosmos_nft_v1beta1_nft_proto_rawDesc = []byte{
	...
	0x62, 0x75, 0x66, 0x2f, 0x61, 0x6e, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdf, 0x01,
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x22,
	0x87, 0x01, 0x0a, 0x03, 0x4e, 0x46, 0x54, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x6c, 0x61, 0x73, 0x73,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x72, 0x69, 0x48, 0x61, 0x73, 0x68, 0x12,
